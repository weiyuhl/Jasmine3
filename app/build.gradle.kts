...
android {
    ...
    applicationVariants.all {
        outputs.all {
            ...
            val apkName = "jasmine_" + defaultConfig.versionName + "_" + variantName + ".apk"
...
//    implementation(libs.androidx.material3.adaptive.navigation3)
    ...
    // JLatexMath
    // https://github.com/jasmine/jlatexmath-android
    ...
    androidTestImplementation(platform(libs.ktorBom))
