...
import com.lhzkml.jasmine.data.datastore.getSelectedTTSProvider
import com.lhzkml.jasmine.utils.stripMarkdown
...
import com.lhzkmltts.controller.TtsController
...
private class CustomTtsStateImpl(
    ...
    private val controller by lazy { com.lhzkmltts.controller.TtsController(context, ttsManager) }
